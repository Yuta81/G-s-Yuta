...
/*現在地から本を検索のためのオートコンプリート*/
          $("#search_term").keyup(function(e){
            ...
            $.post("autocomp.php", {search_term : search_val}, function(data){
              if(data.length>0){
...
/*駅名を入力して検索のためのオートコンプリート*/   
          $("#book_name").keyup(function(e){
            ...
            $.post("autocomp2.php", {book_name : search_val}, function(data){
              if(data.length>0){
...
/*駅名入力後の本検索のためのオートコンプリート*/        
          $("#book_name2").keyup(function(e){
            ...
            $.post("autocomp3.php", {book_name : search_val}, function(data){
              if(data.length>0){
...
<!--   駅を指定して本を検索するためのフォーム  -->
    <form action="search_result_2.php" method="post">

    <input type="text" name="search_term" id="search_term">
    <input type="text" name="book_name" id="book_name2">
    <input type="submit" value="検索">
